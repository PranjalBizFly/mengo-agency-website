...
const ASSIGNMENTS = [
  ...
  /* --------------------------------------------------------- Stage pages */
  ["stage:starting:hero", 12, "A hand writing in a notebook beside a cup of coffee"],
  ["stage:starting:week", 50, "Hands typing on a laptop keyboard"],
  ["stage:solo:hero", 42, "A single desk by a tall window, with plants and a laptop"],
  ["stage:solo:week", 47, "A laptop, pen and coffee cup on a white desk"],
  ["stage:small-team:hero", 24, "Four colleagues working at laptops around a table"],
  ["stage:small-team:week", 18, "A small team working on laptops around a shared table"],
  ["stage:growing:hero", 23, "A long table of people working in a dimly lit room"],
  ["stage:growing:week", 102, "Several people working at laptops around a table"],
  ["stage:established:hero", 98, "A large seated audience facing a presenter in a panelled room"],
  ["stage:established:week", 103, "A modern open-plan office with workstations and breakout seating"],

  /* -------------------------------------------------------- Capabilities */
  ["capabilities:index:hero", 33, "Several people writing and annotating documents at a wooden table"],
  ["capability:brand-strategy:hero", 44, "A woman standing in front of a whiteboard covered in notes"],
  ["capability:blog-content:hero", 9, "Hands working across printed charts, sketches and a phone"],
  ["capability:marketing-calendar:hero", 17, "A hand pinning printed layouts onto a planning wall"],
  ["capability:whatsapp-nurturing:hero", 55, "A person using a phone beside an open laptop"],
  ["capability:sales-performance:hero", 28, "A laptop displaying an analytics dashboard on a desk"],
  ["capability:sops:hero", 20, "An overhead desk with a journal, glasses, coffee and a tablet"],
  ...
  ["workflow:marketing-planning:hero", 4, "Hands gesturing across a meeting table beside an open laptop"],
  ...
  /* ----------------------------------------------------------- Use cases */
  ["usecase:starting:hero", 51, "An open notebook and fountain pen on a wooden desk"],
