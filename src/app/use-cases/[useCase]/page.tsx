...
export function generateStaticParams() {
  return useCases.map((useCase) => ({ useCase: useCase.slug }));
}
    ...
    <>
      ...
      <Section tone="warm">
        <div className="grid gap-x-16 gap-y-14 lg:grid-cols-2">
          <div>
            <Heading kicker="Most relevant at" title="These agency stages" size="d4" width="full" />
            <StoryRows className="mt-9" columns={1} items={relatedStages(useCase.related.stages)} />
          </div>
          <div>
